...
class WeuiGridPreviewComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
...
class WeuiGridSettingComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
...
class WeuiGridsPreviewComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
...
class WeuiGridsSettingComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
...
export { both, preview, entrys, WeuiGridPreviewComponent as ɵa, WeuiGridSettingComponent as ɵc, WeuiGridsPreviewComponent as ɵb, WeuiGridsSettingComponent as ɵd };
//# sourceMappingURL=weui-grids.js.map
