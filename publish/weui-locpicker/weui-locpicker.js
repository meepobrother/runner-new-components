...
class WeuiLocpickerPreviewComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
     * @param {?} dom
     */
    constructor(_differs, _ele, _render, dom) {
...
class WeuiLocpickerSettingComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
...
//# sourceMappingURL=weui-locpicker.js.map
