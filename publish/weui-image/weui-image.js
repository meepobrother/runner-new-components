...
class WeuiImagePreviewComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
 ...
 * @nocollapse
 */
WeuiImagePreviewComponent.ctorParameters = () => [
    { type: KeyValueDiffers, },
    { type: ElementRef, },
    { type: Renderer2, },
];

class WeuiImageSettingComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
 ...
 * @nocollapse
 */
WeuiImageSettingComponent.ctorParameters = () => [
    { type: KeyValueDiffers, },
    { type: ElementRef, },
    { type: Renderer2, },
];
...
export { both, preview, entrys, WeuiImagePreviewComponent as ɵa, WeuiImageSettingComponent as ɵb };
//# sourceMappingURL=weui-image.js.map
