...
class WeuiSwiperPreviewComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
 ...
 * @nocollapse
 */
WeuiSwiperPreviewComponent.ctorParameters = () => [
    { type: KeyValueDiffers, },
    { type: ElementRef, },
    { type: Renderer2, },
];

class WeuiSwiperSettingComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
 ...
 * @nocollapse
 */
WeuiSwiperSettingComponent.ctorParameters = () => [
    { type: KeyValueDiffers, },
    { type: ElementRef, },
    { type: Renderer2, },
];

class WeuiSwiperItemPreviewComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
 ...
 * @nocollapse
 */
WeuiSwiperItemPreviewComponent.ctorParameters = () => [
    { type: KeyValueDiffers, },
    { type: ElementRef, },
    { type: Renderer2, },
];

class WeuiSwiperItemSettingComponent extends ReactComponent {
    /**
     * @param {?} _differs
     * @param {?} _ele
     * @param {?} _render
 ...
 * @nocollapse
 */
WeuiSwiperItemSettingComponent.ctorParameters = () => [
    { type: KeyValueDiffers, },
    { type: ElementRef, },
    { type: Renderer2, },
];
...
//# sourceMappingURL=weui-swiper.js.map
